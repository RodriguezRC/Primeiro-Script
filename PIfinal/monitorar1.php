  ...
  <body>
    ...
    <div class="capa">
      ...
      <div class="texto-capa ">
          <h1>Vagando </br></br> Você está monitorando a Unidade I </h1>
      </div>
...
$verificar_vagas = mysqli_query($con, "SELECT * FROM unidadeum WHERE vagas = '$vagas' ");
...
$deletar_vagas = "TRUNCATE TABLE unidadeum";
