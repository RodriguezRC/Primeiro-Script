    ...
    <div class="capa">
      ...
      <div class="texto-capa ">
       ...
       <div class="col-sm-12" align="center">
                ...
                <form method="POST" action="" class="modal-sm" id="box">
...
$resultado_recebido=mysqli_query($con, "SELECT * FROM usuariotres WHERE nome='$login' AND senha='$senha'");
...
header("Location:monitorar2.php?session=$num");
